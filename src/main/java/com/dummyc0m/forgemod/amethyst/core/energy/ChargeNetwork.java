...
public class ChargeNetwork implements INetwork {
    ...
    @Override
    public boolean addConnector(INetworkConnector.IConnectorProducer connector) {
        if (connector.getWorld().provider.getDimensionId() == world.provider.getDimensionId()) {
    ...
    @Override
    public boolean addConnector(INetworkConnector.IConnectorConsumer connector) {
        if (connector.getWorld().provider.getDimensionId() == world.provider.getDimensionId()) {
